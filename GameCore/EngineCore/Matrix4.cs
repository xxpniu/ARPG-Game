...
namespace EngineCore
{
    public struct Matrix4 : IEquatable<Matrix4>
    {
        ...
        /// </summary>
        public GVector4 Row0;

        /// <summary>
        /// 2nd row of the matrix.
        /// </summary>
        public GVector4 Row1;

        /// <summary>
        /// 3rd row of the matrix.
        /// </summary>
        public GVector4 Row2;

        /// <summary>
        /// Bottom row of the matrix.
        /// </summary>
        public GVector4 Row3;

        /// <summary>
        /// The identity matrix.
        /// </summary>
        public static readonly Matrix4 Identity = new Matrix4(GVector4.UnitX, GVector4.UnitY, GVector4.UnitZ, GVector4.UnitW);

        /// <summary>
        /// The zero matrix.
        /// </summary>
        public static readonly Matrix4 Zero = new Matrix4(GVector4.Zero, GVector4.Zero, GVector4.Zero, GVector4.Zero);
        ...
        public Matrix4(GVector4 row0, GVector4 row1, GVector4 row2, GVector4 row3)
        {
            Row0 = row0;
            Row1 = row1;
            Row2 = row2;
        ...
        {
            Row0 = new GVector4(m00, m01, m02, m03);
            Row1 = new GVector4(m10, m11, m12, m13);
            Row2 = new GVector4(m20, m21, m22, m23);
            Row3 = new GVector4(m30, m31, m32, m33);
        }
        ...
        /// </summary>
        public GVector4 Column0
        {
            get { return new GVector4(Row0.X, Row1.X, Row2.X, Row3.X); }
        ...
        /// </summary>
        public GVector4 Column1
        {
            get { return new GVector4(Row0.Y, Row1.Y, Row2.Y, Row3.Y); }
        ...
        /// </summary>
        public GVector4 Column2
        {
            get { return new GVector4(Row0.Z, Row1.Z, Row2.Z, Row3.Z); }
        ...
        /// </summary>
        public GVector4 Column3
        {
            get { return new GVector4(Row0.W, Row1.W, Row2.W, Row3.W); }
        ...
        /// </summary>
        public GVector4 Diagonal
        {
            get
            {
                return new GVector4(Row0.X, Row1.Y, Row2.Z, Row3.W);
            }
            set
            {
                Row0.X = value.X;
        ...
        {
            Matrix4 m = this;
            if (Math.Abs(m.Determinant) > MathHelper. EPSILON)
                m.Invert();
            return m;
        }
        ...
        {
            Matrix4 m = this;
            m.Row0.Xyz = new GVector3(m.Row0.Xyz.Length, 0, 0);
            m.Row1.Xyz = new GVector3(0, m.Row1.Xyz.Length, 0);
            m.Row2.Xyz = new GVector3(0, 0, m.Row2.Xyz.Length);
            return m;
        }
        /// <summary>
        ...
        /// </summary>
        public GVector3 ExtractTranslation() { return Row3.Xyz; }

        /// <summary>
        /// Returns the scale component of this instance.
        /// </summary>
        public GVector3 ExtractScale() { return new GVector3(Row0.Xyz.Length, Row1.Xyz.Length, Row2.Xyz.Length); }
        ...
        /// </summary>
        public GVector4 ExtractProjection()
        {
            return Column3;
        }
        ...
        public static void CreateFromAxisAngle(GVector3 axis, float angle, out Matrix4 result)
        {
        ...
        public static Matrix4 CreateFromAxisAngle(GVector3 axis, float angle)
        {
            Matrix4 result;
        ...
        /// <param name="result">The resulting Matrix4 instance.</param>
        public static void CreateTranslation(ref GVector3 vector, out Matrix4 result)
        {
            result = Identity;
        ...
        /// <param name="vector">The translation vector.</param>
        /// <returns>The resulting Matrix4 instance.</returns>
        public static Matrix4 CreateTranslation(GVector3 vector)
        {
            Matrix4 result;
        ...
        /// <returns>A scale matrix.</returns>
        public static Matrix4 CreateScale(GVector3 scale)
        {
            Matrix4 result;
        ...
        /// <param name="scale">Scale factors for the x, y, and z axes.</param>
        /// <param name="result">A scale matrix.</param>
        public static void CreateScale(ref GVector3 scale, out Matrix4 result)
        {
            result = Identity;
        ...
        public static Matrix4 Translation(GVector3 trans)
        {
        ...
        public static Matrix4 Rotate(GVector3 axis, float angle)
        {
        ...
        /// <returns>A scaling matrix</returns>
        [Obsolete("Use CreateScale instead.")]
        public static Matrix4 Scale(GVector3 scale)
        {
        ...
        {
            Matrix4 result;
            result.Row0 = GVector4.UnitX * x;
            result.Row1 = GVector4.UnitY * y;
            result.Row2 = GVector4.UnitZ * z;
            result.Row3 = GVector4.UnitW;
            return result;
        }
        ...
        public static Matrix4 Frustum(float left, float right, float bottom, float top, float near, float far)
        {
            ...
            return new Matrix4(new GVector4(2.0f * near * invRL, 0.0f, 0.0f, 0.0f),
                               new GVector4(0.0f, 2.0f * near * invTB, 0.0f, 0.0f),
                               new GVector4((right + left) * invRL, (top + bottom) * invTB, -(far + near) * invFN, -1.0f),
                               new GVector4(0.0f, 0.0f, -2.0f * far * near * invFN, 0.0f));
        }
        ...
        public static Matrix4 LookAt(GVector3 eye, GVector3 target, GVector3 up)
        {
            GVector3 z = GVector3.Normalize(eye - target);
            GVector3 x = GVector3.Normalize(GVector3.Cross(up, z));
            GVector3 y = GVector3.Normalize(GVector3.Cross(z, x));
        ...
        {
            return LookAt(new GVector3(eyeX, eyeY, eyeZ), new GVector3(targetX, targetY, targetZ), new GVector3(upX, upY, upZ));
        }
