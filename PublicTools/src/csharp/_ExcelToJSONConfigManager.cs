...
namespace ExcelConfig
{
    ...
    public class ExcelToJSONConfigManager
    {
        ...
        public T[] GetConfigs<T>(FindCondition<T> condition) where T : JSONConfigBase
        {
            TryToLoad<T>();
            var ty = typeof(T);
		...
		public List<T> GetListConfigs<T>() where T : JSONConfigBase
        {
            TryToLoad<T>();
            var ty = typeof(T);
            var list = new List<T>(16);
		...
		public List<T> GetListConfigs<T>(FindCondition<T> condition) where T : JSONConfigBase
        {
            TryToLoad<T>();
            var ty = typeof(T);
            var list = new List<T>(16);
