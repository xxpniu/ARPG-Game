...
namespace DapperQ
{
    public class MemberCache
    {
        ...
        static volatile Dictionary<int, string> dict = null;
...
#if CSHARP30
        public string Find(int hashCode)
        {
            this.Find(hashCode, null);
        }
        public string Find(int hashCode, string defaultValue)
#else
        public static string Find(int hashCode, string defaultValue = null)
#endif
        {
            ...
            lock (lockor)
            {
                dict.Add(hashCode, defaultValue);
                return defaultValue;
            }
        }
    }
